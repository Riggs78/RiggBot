...
public class SuperSlotCommand extends Command {
	public SuperSlotCommand() {
		this.name = "superslot";
		this.aliases = new String[] { "superslots", "supers", "sslot", "sslots", "ss" };
		this.botPermissions = new Permission[] { Permission.MESSAGE_WRITE };
		this.help = "Try for a lot of Jackpots";
		this.arguments = "(trys)";
